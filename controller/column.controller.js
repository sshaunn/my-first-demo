...
async function addColumn(req, res) {
  ...
  if (!column.id || !column.type || !column.taskIds) {
...
//     } else {
//         data.forEach((doc) => {
//             const colorder = doc.data().id;
//             //columnOrder = [... colorder];
//             columnOrder.push(colorder);
//           });
//           console.log(columnOrder);
//           //const result = arrayToObject(columnOrder, "id");
//           //console.log({ ...result, columnOrder });
  ...
  try {
    ...
    if (data.empty) {
      ...
      data.forEach((doc) => {
        ...
        columnOrder.push(doc.id);
        columnList.push(columns);
      });
      //console.log(arrayToObject(columnsObject, 'id'));
      //console.log(columnOrder);
      const result = arrayToObject(columnList, 'id');
      //console.log(columns);
      res.json({...result, columnOrder});
    }
  } catch (error) {
